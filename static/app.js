...
function stepThroughKMeans() {
    ...
    const k = parseInt(document.getElementById("num-clusters").value,10); // Get the number of clusters
...
function stepBThroughKMeans() {
    ...
    const method = document.getElementById("init-method").value;
    const k = parseInt(document.getElementById("num-clusters").value,10);
    console.log("num_clusers:", k);
...
document.getElementById("num-clusters").addEventListener("change", function() {
    ...
    console.log("Updated number of clusters:", k);
});
